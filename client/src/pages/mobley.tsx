  ...
  return (
    <div className="h-full bg-slate-950 text-white flex flex-col overflow-hidden w-full">
      ...
      <header className="sticky top-0 left-0 right-0 flex items-end justify-between px-4 pb-3 pt-safe border-b border-slate-800 bg-slate-950 z-50">
        ...
        <div className="shrink-0 md:shrink md:flex-1 flex flex-col overflow-auto px-4 md:pb-96 md:border-r md:border-slate-800" style={{ width: '100vw' }}>
        ...
        {/* Chat panel */}
        <div className="shrink-0 md:shrink-0 md:w-80 flex flex-col bg-slate-950 md:border-r md:border-slate-800" style={{ width: '100vw' }}>
        ...
        <div className="md:hidden sticky bottom-0 left-0 right-0 px-3 pb-safe pt-2 bg-slate-950 border-t border-slate-800 z-50">
          <div className="flex gap-2 items-center">
            ...
            <input
              ...
              onChange={e => setChatInput(e.target.value)}
              onKeyDown={e => { if (e.key === 'Enter' && !e.shiftKey) { e.preventDefault(); sendChatMessage(); } }}
              onFocus={(e) => { if (activeTab !== 'chat' && e.isTrusted) setActiveTab('chat'); }}
              placeholder="Message..."
              maxLength={1000}
              className="flex-1 bg-slate-800 border border-slate-700 rounded-full px-4 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/50"
            ...
            {flicSupported !== false && (
              <div className="mb-6">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-slate-700 hover:bg-slate-600 disabled:opacity-50 text-white font-medium py-3 rounded-full transition-colors"
